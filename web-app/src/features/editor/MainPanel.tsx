    ...
    return (
        ...
        <div className="main-panel">
            <div className='sprite__header'>
                ...
                <button className='btn btn--primary' onClick={() => setSaveOpen(true)}>Save</button>
            </div>
        ...
        <Modal isOpen={saveOpen} onClose={() => setSaveOpen(false)} title="Save Sprite">
            <form className="form" onSubmit={e => { e.preventDefault(); setSaveOpen(false); }}>
                <div className="form__field">
                    <label className="form__label">Project name</label>
                    <input className="form__input" value={projectName} onChange={e => setProjectName(e.target.value)} />
                </div>
                <div className="form__field">
                    <label className="form__label">Group name</label>
                    <input className="form__input" value={groupName} onChange={e => setGroupName(e.target.value)} />
                </div>
                <div className="form__field">
                    <label className="form__label">Sprite name</label>
                    <input className="form__input" value={spriteName} onChange={e => setSpriteName(e.target.value)} />
                </div>
